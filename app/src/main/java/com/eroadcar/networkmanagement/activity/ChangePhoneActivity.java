            ...
            switch (msg.what) {
                case 1:
                    if (bean.getState().equals("success")) {
                        application.getUserBean().setMg_cellphone(mobile_cet.getText().toString());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.back_btn:
                ...
                break;
            case R.id.other_btn:
                modifyUser(application.getUserBean().getMg_code(), "",
                        mobile_cet.getText().toString(), "", application.getUserBean().getMg_shopsid(),
